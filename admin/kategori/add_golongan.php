	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="id_gol" name="id_gol" placeholder="ID Golongan" required>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="deskripsi_gol" name="deskripsi_gol" placeholder="Deskripsi Golongan">
				</div>
			</div>
...
<?php
    ...
    //mulai proses simpan data
        $sql_simpan = "INSERT INTO golongan (id_gol,deskripsi_gol) VALUES (
        '".$_POST['id_gol']."',
        '".$_POST['deskripsi_gol']."')";
