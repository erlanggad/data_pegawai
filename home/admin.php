...
<?php
	...
	$sql = $koneksi->query("SELECT count(id_kar) as lokal from data_karyawan where id_status='9.0.00'");
...
<?php
	$sql = $koneksi->query("SELECT count(id_kar) as putra from data_karyawan where id_status='9.0.01'");
	while ($data= $sql->fetch_assoc()) {
...
<?php
	$sql = $koneksi->query("SELECT count(id_kar) as putri from data_karyawan where id_status='9.0.02'");
	while ($data= $sql->fetch_assoc()) {
