	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				<img src="dist/img/logopdam.png" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
			...
			<div class="sidebar">
				...
				<nav class="mt-2">
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<li class="nav-item">
							<a href="?page=dataapegawai" class="nav-link">
								<i class="nav-icon far fa fa-users"></i>
								<p>
									Data Pegawai
								</p>
      ...
      if(isset($_GET['page'])){
          ...
          switch ($hal) {
              //Klik Halaman Home Pengguna
				...
				//Asrama
				case 'dataapegawai':
					include "admin/pegawai/data_pegawaiuser.php";
					break;
				case 'data-pegawai':
				...
				case 'view-pegawai':
					...
					break;
				case 'view-pegawai-user':
					include "admin/pegawai/view_pegawai_user.php";
					break;
    ...
    ?>
		...
		<footer class="main-footer">
			<div class="float-right d-none d-sm-block">
				Copyright &copy;
					<strong> PERUMDAM TIRTA AGRAPURA</strong>
				</a>
				All rights reserved.
			</div>
			<b>Created @2023</b>
